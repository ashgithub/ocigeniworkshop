"""
What this file does:
Sample test client for the city agent, demonstrating how to interact with the A2A agent using A2A client.
...
async def test_city_agent() -> None:
    """Send a test query to the city agent and print the response."""

    test_query = "Recommend a city for a tech conference"
