"""
What this file does:
Sample test client for the weather agent, demonstrating how to interact with the A2A agent using A2A client.
...
async def test_weather_agent() -> None:
    """Send a test query to the weather agent and print the response."""
    ...
    test_query = "What's the weather like in Chicago today?"
